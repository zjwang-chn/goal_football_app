...
if page == "首页":
    ...
    if not st.session_state.analysis_records:
        ...
        column_config = {
            ...
            "胜概率": st.column_config.TextColumn(width=70),
            "平概率": st.column_config.TextColumn(width=70),
            "负概率": st.column_config.TextColumn(width=70),
            "主进球": st.column_config.TextColumn(width=70),
            "客进球": st.column_config.TextColumn(width=70),
            "胜赔付": st.column_config.TextColumn(width=70),
            "平赔付": st.column_config.TextColumn(width=70),
            "负赔付": st.column_config.TextColumn(width=70),
            "0球": st.column_config.TextColumn(width=50),
            "1球": st.column_config.TextColumn(width=50),
            "2球": st.column_config.TextColumn(width=50),
            "3球": st.column_config.TextColumn(width=50),
            "4球": st.column_config.TextColumn(width=50),
            "5球": st.column_config.TextColumn(width=50),
            "6球": st.column_config.TextColumn(width=50),
            "7+球": st.column_config.TextColumn(width=50),
